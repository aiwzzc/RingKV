...
public:
    ...
    using LoopsEnginesPtr = std::vector<std::pair<AeroIO::net::EventLoop*, Ringengine*>>*;

    explicit LoaderManager(Ringengine* engine, LoopsEnginesPtr LoopsEngines);
    
    void start();

private:
    Ringengine* engine_;
    LoopsEnginesPtr LoopsEngines_;
